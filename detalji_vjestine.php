...
if($id != 0){
    $query = $db->query("SELECT * FROM vjestine WHERE id = $id");
...
<form  method="post" action="detalji_vjestine_sql.php" enctype="multipart/form-data" name="form" id="forma-detalji">
    <div class="row">
