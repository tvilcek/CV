...
<?php
      $izraz = $db -> prepare("select * from dodatne_inf");  
      $izraz -> execute();
      ...
      <tr>
          ...
          <td><a href='detalji_dodatne_inf.php?id=<?php echo $r->id; ?>'>Detalji</a></td>
      </tr>
 <?php } ?>
     <tr>
       <td colspan="3"><a href='detalji_dodatne_inf.php?id=0'>Dodaj novu informaciju</a></td>
     </tr>
