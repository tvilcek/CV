...
if($id != 0){
    $query = $db->query("SELECT * FROM dodatne_inf WHERE id = $id");
...
<div class="card-user-profile">
  <img class="card-user-profile-img" src="slike/pattern_6.jpg" alt="picture of space" />
...
<form  method="post" action="detalji_dodatne_inf_sql.php" enctype="multipart/form-data" name="form" id="forma-detalji">
  <div class="row">
    ...
    <div class="large-8 columns">
      ...
      <!--   <textarea rows="15" cols="50" name="vrijednost" value="<?php echo $vrijednost;?>"/> 
      </textarea> -->
      </label>
    </div>
  </div>
